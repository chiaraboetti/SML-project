...
\begin{itemize}
	\item \textit{Cross-validation}: we performed a 5-fold Cross-validation on the model and selected the top most important features of each model; % and finally averaged;
